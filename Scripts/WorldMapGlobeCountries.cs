...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        /// </summary>
        public void BlinkCountry(int countryIndex, Color color1, Color color2, float duration, float blinkingSpeed, bool smoothBlink = false, bool includeAllRegions = false) {
            ...
            if (includeAllRegions) {
                ...
                BlinkCountry(countryIndex, country.mainRegionIndex, color1, color2, duration, blinkingSpeed, smoothBlink);
            }
        }
